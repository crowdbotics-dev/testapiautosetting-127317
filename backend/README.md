...
## Project Structure
    ...
    ├── testapiautosetting_127317  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127317`
...
2. Clone this repo and `cd testapiautosetting_127317`
